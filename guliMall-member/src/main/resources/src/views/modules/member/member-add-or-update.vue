<template>
  <el-dialog
    ...
    <el-form-item label="社交平台uid" prop="socialUid">
      <el-input v-model="dataForm.socialUid" placeholder="社交平台uid"></el-input>
    </el-form-item>
    <el-form-item label="社交平台给的访问令牌" prop="accessToken">
      <el-input v-model="dataForm.accessToken" placeholder="社交平台给的访问令牌"></el-input>
    </el-form-item>
    <el-form-item label="当次令牌的过期时间，单位s" prop="expireIn">
      <el-input v-model="dataForm.expireIn" placeholder="当次令牌的过期时间，单位s"></el-input>
    </el-form-item>
    <el-form-item label="注册类型[0-本平台，1-微博，2-微信]" prop="registerType">
      <el-input v-model="dataForm.registerType" placeholder="注册类型[0-本平台，1-微博，2-微信]"></el-input>
    </el-form-item>
    ...
    <el-form-item label="性别[1-男，0-女]" prop="gender">
      <el-input v-model="dataForm.gender" placeholder="性别[1-男，0-女]"></el-input>
    </el-form-item>
    ...
    <el-form-item label="启用状态[0启用，1-禁用]" prop="status">
      <el-input v-model="dataForm.status" placeholder="启用状态[0启用，1-禁用]"></el-input>
    </el-form-item>
  ...
  export default {
    data () {
      return {
        ...
        dataRule: {
          socialUid: [
            { required: true, message: '社交平台uid不能为空', trigger: 'blur' }
          ],
          accessToken: [
            { required: true, message: '社交平台给的访问令牌不能为空', trigger: 'blur' }
          ],
          expireIn: [
            { required: true, message: '当次令牌的过期时间，单位s不能为空', trigger: 'blur' }
          ],
          registerType: [
            { required: true, message: '注册类型[0-本平台，1-微博，2-微信]不能为空', trigger: 'blur' }
          ],
          levelId: [
          ...
          gender: [
            { required: true, message: '性别[1-男，0-女]不能为空', trigger: 'blur' }
          ],
          birth: [
          ...
          status: [
            { required: true, message: '启用状态[0启用，1-禁用]不能为空', trigger: 'blur' }
          ],
          createTime: [
          ...
          if (this.dataForm.id) {
            this.$http({
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.expireIn = data.member.expireIn
                this.dataForm.registerType = data.member.registerType
          ...
          if (valid) {
            this.$http({
              ...
              data: this.$http.adornData({
                ...
                'expireIn': this.dataForm.expireIn,
